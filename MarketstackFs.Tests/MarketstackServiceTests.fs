...
let msOptions: MarketstackOptions = { ApiToken = testKey; MaxRequestsPerSecond = 1; Https = false }
let subject = MarketstackService (msOptions) :> IMarketstackService
